    ...
    *,
    ...
    if admin:
        return (
            ...
            "/adminpayments — full list: every payment with starter, finisher, card, status\n"
            "/paybuttons — tap to mark each payment cleared/not cleared\n"
            "/payout — who you owe (cleared payments only, auto-updates for new payments)\n"
            "/setpaid @user — mark agent as paid, removes from /payout\n"
            "/paylog — history of who you've paid\n"
            ...
            "/setcleared — mark cleared (reply to out)\n"
            ...
            "<b>📞 Calls</b>\n"
            "/attendance — linked agents & call counts\n"
            "/resetattendance — reset attendance counts\n"
            "/missedcalls — download missed calls CSV (today · 7 · all)\n\n"
            "<b>🔗 Extensions</b>\n"
            "/link — link extension (reply to user) · /unlink · /links · /users\n"
            "/clearlinks — unlink all agents\n"
            "/setnotify — set announcement group\n"
            "/setnotifypayments — live payment list in a group\n"
            "/setnotifyexpenses — set expenses logging group\n"
            "/setexpenses — live expense table in a group\n"
            ...
            "<b>📣 Broadcast</b>\n"
            "/blast [message] — pin message in group\n"
            "/content — show current blast content\n"
            "/remind [time] [note] — set a personal reminder\n\n"
