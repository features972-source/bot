    ...
    *,
    ...
    if admin:
        return (
            ...
            "<b>💸 Payments</b>\n"
            "/payments — all payments summary\n"
            "/paybuttons — tap to mark each payment Paid/Not Cleared\n"
            "/payout — who you owe (5% starter · 15% finisher, deducts paid)\n"
            "/pay @user amount — record you've paid an agent\n"
            "/paylog — history of payments made\n"
